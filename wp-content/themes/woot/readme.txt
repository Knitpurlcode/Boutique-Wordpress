...
-> http://www.pexels.com/photo/fashion-man-person-wristwatch-1597/
 ...
 * First public release
 ...
 Version 1.0.1
 * updated woot-setup.php
 * updated structure/header.php
 * updated hooks.php
 * updated style.css
 * updated structure/footer.php
 * updated structure/post.php
 ...
 * updated woot-setup.php
  ...
  * updated structure files

  Version 1.0.5
  * fixed the accessibility issues

  Version 1.0.6
  * Keyboard Navigation is now working
  * mobile menu toggle is now working
  * move the skip links on the top of the page

  Version 1.0.7
  * updated accent color

  Version 1.0.8
  * updated woot theme base on the storefront major changes, fixed the errors https://github.com/woothemes/storefront/blob/master/changelog.md#20160506---200
  ...
  * removed storefront_html_tag_schema
  ...
  Version 2.0.4
  * removed content-single.php file

  Version 2.0.5
  * updated style.css
  * updated class-woot.php
  ...
  * updated style.css
  ...
  Version 2.0.7
  * updated woot-template-functions.php

  Version 2.0.8
  * updated woot-template-functions.php

  Version 2.0.9
  * fixed small issue in header area

  Version 3.0
  * remove archive-product template(deprecated woocommerce template)

  Version 3.0.1
  * updated mobile banner area 
  * updated mobile product area title font size
